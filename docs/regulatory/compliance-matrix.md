...
| FDA Device Software Functions (2023) | Software description, level of concern, requirements traceability | `docs/regulatory/software-description.md`, `docs/validation/traceability-matrix-template.csv`, `backend/api-service/app/schemas/` |
...
| 21 CFR Part 11 | Audit trails, electronic signatures, system validation | `backend/api-service/app/models/domain.py`, `docs/validation/validation-master-plan.md`, `validation/` |
